...
const THEMES = {
  ...
  ipad: {
    name: { es: "iPad", en: "iPad" }, sub: { es: "Amplio para tablet", en: "Spacious for tablet" }, ui: { maxW: "max-w-3xl", tips: false, rootPx: 18, page: "#e3e8f0", cardScale: 1.28 },
...
const LEVELS = [
  {
    ...
    dealsTarget: 40,
    lessons: [
      { id: "l1a", ex: [{ t:{es:"Leer tu mano",en:"Reading your hand"}, hands:[{ label:{es:"Tu mano",en:"Your hand"}, showHCP:true, h:{"♠":"AK73","♥":"QJ5","♦":"K82","♣":"942"} }], note:{es:"Recibes 13 cartas y las ordenas por palos. Aquí cuentas A=4, K=3 (♠), Q=2, J=1 (♥), K=3 (♦) = 13 PH. La forma 4-3-3-3 es equilibrada.",en:"You get 13 cards and sort them by suit. Here A=4, K=3 (♠), Q=2, J=1 (♥), K=3 (♦) = 13 HCP. The 4-3-3-3 shape is balanced."} }], t: { es: "La baraja, las bazas y la mesa", en: "The deck, tricks and the table" },
      ...
      { id: "l1b", ex: [{ t:{es:"Contar puntos",en:"Counting points"}, hands:[{ label:{es:"Equilibrada",en:"Balanced"}, showHCP:true, h:{"♠":"AQ4","♥":"KJ73","♦":"A9","♣":"852"} },{ label:{es:"Con un corto",en:"With shortness"}, showHCP:true, h:{"♠":"KQJ962","♥":"A7","♦":"K853","♣":"4"} }], note:{es:"La 1ª vale 14 PH y es plana → Sin Triunfo. La 2ª tiene 13 PH pero con un singleton ♣ (+2 con ajuste) y un palo de 6: vale más de lo que dicen los puntos.",en:"The 1st has 14 HCP and is flat → Notrump. The 2nd has 13 HCP but a singleton ♣ (+2 with a fit) and a 6-card suit: worth more than the raw points."} }], t: { es: "Puntos de honor y distribución", en: "High-card points and distribution" },
      ...
      { id: "l1c", ex: [{ t:{es:"Equilibrada vs desequilibrada",en:"Balanced vs unbalanced"}, hands:[{ label:{es:"Equilibrada (4-3-3-3)",en:"Balanced (4-3-3-3)"}, h:{"♠":"KJ5","♥":"A84","♦":"Q972","♣":"K63"} },{ label:{es:"Desequilibrada (6-1-4-2)",en:"Unbalanced (6-1-4-2)"}, h:{"♠":"AKQ853","♥":"9","♦":"KJ72","♣":"Q4"} }], note:{es:"La equilibrada no tiene cortos: prefiere Sin Triunfo. La desequilibrada tiene un palo de 6 y un singleton ♥: prefiere un contrato con triunfo para fallar y usar la longitud.",en:"The balanced hand has no shortness: it prefers Notrump. The unbalanced one has a 6-card suit and a singleton ♥: it prefers a trump contract to ruff and use length."} }], t: { es: "Tipos de mano: equilibrada o no", en: "Hand types: balanced or not" },
      ...
      { id: "l1e", ex: [{ t:{es:"Buscar el ajuste de 8",en:"Finding the 8-card fit"}, hands:[{ label:{es:"Tú",en:"You"}, h:{"♠":"74","♥":"KQ962","♦":"AJ5","♣":"832"} },{ label:{es:"Compañero",en:"Partner"}, h:{"♠":"A83","♥":"A743","♦":"K6","♣":"QJ95"} }], note:{es:"Juntos tenéis 5+4 = 9 cartas de ♥: ajuste mayor. Jugad 4♥ (triunfo), donde podréis fallar y controlar, mejor que 3ST.",en:"Together you hold 5+4 = 9 hearts: a major fit. Play 4♥ (trumps), where you can ruff and keep control, rather than 3NT."} }], t: { es: "Triunfo contra Sin Triunfo", en: "Trump versus Notrump" },
      ...
      { id: "l1f", ex: [{ t:{es:"Contar perdedoras en 4♠",en:"Counting losers in 4♠"}, hands:[{ label:{es:"Tu mano (declarante)",en:"Your hand (declarer)"}, h:{"♠":"AKQ54","♥":"A3","♦":"K72","♣":"865"} },{ label:{es:"Muerto",en:"Dummy"}, h:{"♠":"876","♥":"KQ5","♦":"A43","♣":"9742"} }], note:{es:"Perdedoras: ♠ 0 (AKQ), ♥ 0 (AKQ entre las dos manos), ♦ 1, ♣ 3 = 4. Una de más para 4♠. Plan: falla 1-2 tréboles en el muerto (tiene 3 triunfos) y bajas a 2-3 perdedoras. Cumples.",en:"Losers: ♠ 0 (AKQ), ♥ 0 (AKQ between the hands), ♦ 1, ♣ 3 = 4. One too many for 4♠. Plan: ruff 1-2 clubs in dummy (it has 3 trumps) to get down to 2-3 losers. You make it."} }], t: { es: "Plan de bazas: ganadoras y perdedoras", en: "Counting winners and losers" },
  ...
  },
  {
    ...
    dealsTarget: 60,
    lessons: [
      { id: "l2a", ex: [{ t:{es:"La regla de 20",en:"The rule of 20"}, hands:[{ label:{es:"Mano",en:"Hand"}, showHCP:true, h:{"♠":"KQT62","♥":"AJ73","♦":"5","♣":"K84"} }], note:{es:"13 PH + las dos longitudes mayores (5+4=9) = 22 ≥ 20 → abre. Aquí abres 1♠.",en:"13 HCP + your two longest suits (5+4=9) = 22 ≥ 20 → open. Here you open 1♠."} }], t: { es: "Cuándo abrir y la regla de 20", en: "When to open and the rule of 20" },
      ...
      { id: "l2b", ex: [{ t:{es:"Abrir 1♥/1♠ (mayor de 5)",en:"Open 1♥/1♠ (5-card major)"}, hands:[{ label:{es:"Mano",en:"Hand"}, showHCP:true, h:{"♠":"AQ964","♥":"K3","♦":"AT72","♣":"85"} }], note:{es:"13 PH y 5 picas → abre 1♠. Con un mayor de 5+ casi siempre lo abres.",en:"13 HCP and 5 spades → open 1♠. With a 5+ card major you almost always open it."} }], t: { es: "Qué significa abrir 1♥ o 1♠", en: "What opening 1♥ or 1♠ means" },
      ...
      { id: "l2c", ex: [{ t:{es:"Abrir 1♣/1♦ (menor)",en:"Open 1♣/1♦ (minor)"}, hands:[{ label:{es:"Mano",en:"Hand"}, showHCP:true, h:{"♠":"A73","♥":"K84","♦":"KJ95","♣":"Q62"} }], note:{es:"13 PH pero sin mayor de 5 → abre tu menor más largo: 1♦.",en:"13 HCP but no 5-card major → open your longer minor: 1♦."} }], t: { es: "Qué significa abrir 1♣ o 1♦", en: "What opening 1♣ or 1♦ means" },
      ...
      { id: "l2d", ex: [{ t:{es:"Abrir 1ST (15-17)",en:"Open 1NT (15-17)"}, hands:[{ label:{es:"Mano",en:"Hand"}, showHCP:true, h:{"♠":"AQ7","♥":"KJ5","♦":"AT83","♣":"K42"} }], note:{es:"17 PH y forma equilibrada (3-3-4-3) → abre 1ST. Describe puntos y forma en una sola voz.",en:"17 HCP and balanced (3-3-4-3) → open 1NT. It shows points and shape in one bid."} }], t: { es: "Qué significa abrir 1ST (15-17)", en: "What opening 1NT (15-17) means" },
      ...
      { id: "l2e", ex: [{ t:{es:"Apoyo a 1 mayor",en:"Raising a major"}, hands:[{ label:{es:"Compañero abre 1♠",en:"Partner opens 1♠"}, showHCP:true, h:{"♠":"KT63","♥":"A84","♦":"952","♣":"Q73"} }], note:{es:"Con 4 picas y 9 puntos subes a 2♠: ya tenéis ajuste de 8+.",en:"With 4 spades and 9 points raise to 2♠: you already have an 8+ fit."} }], t: { es: "Respuestas a 1 mayor: el apoyo", en: "Responses to 1 major: the raise" },
      ...
      { id: "l2f", ex: [{ t:{es:"Responder sin fit",en:"Responding without a fit"}, hands:[{ label:{es:"Compañero abre 1♠",en:"Partner opens 1♠"}, showHCP:true, h:{"♠":"84","♥":"KQT63","♦":"A72","♣":"J54"} }], note:{es:"Sin apoyo a ♠ pero con 10 puntos y 5 corazones → responde 2♥ (palo nuevo a nivel 2).",en:"No spade support but 10 points and 5 hearts → respond 2♥ (new suit at the 2-level)."} }], t: { es: "Respuestas a 1 mayor sin fit", en: "Responses to 1 major without a fit" },
      ...
      { id: "l2g", ex: [{ t:{es:"El rebid del abridor",en:"Opener's rebid"}, hands:[{ label:{es:"Tú abriste 1♠",en:"You opened 1♠"}, showHCP:true, h:{"♠":"AKJ72","♥":"Q4","♦":"AJ86","♣":"53"} }], note:{es:"Tras 1♠–1ST, enseña tu 2º palo: rebid 2♦. El rebid afina puntos y forma.",en:"After 1♠–1NT, show your second suit: rebid 2♦. The rebid refines points and shape."} }], t: { es: "El rebid del abridor", en: "Opener's rebid" },
      ...
      { id: "l2h", ex: [{ t:{es:"Stayman",en:"Stayman"}, hands:[{ label:{es:"Compañero abrió 1ST",en:"Partner opened 1NT"}, showHCP:true, h:{"♠":"KJ72","♥":"AT63","♦":"Q5","♣":"942"} }], note:{es:"Con 4-4 en mayores y valores de invite, pregunta con 2♣ (Stayman) por un mayor de 4.",en:"With 4-4 majors and invitational values, ask 2♣ (Stayman) for a 4-card major."} }], t: { es: "Stayman: ¿tienes mayor de 4?", en: "Stayman: do you hold a 4-card major?" },
      ...
      { id: "l2i", ex: [{ t:{es:"Transferencia Jacoby",en:"Jacoby transfer"}, hands:[{ label:{es:"Compañero abrió 1ST",en:"Partner opened 1NT"}, showHCP:true, h:{"♠":"53","♥":"KJ8642","♦":"Q97","♣":"84"} }], note:{es:"Con 6 corazones, transfiere: 2♦ obliga al abridor a decir 2♥; luego el muerto jugará bien protegido.",en:"With 6 hearts, transfer: 2♦ makes opener bid 2♥; the strong hand becomes declarer."} }], t: { es: "Transferencias Jacoby", en: "Jacoby transfers" },
      ...
      { id: "l2j", ex: [{ t:{es:"Aperturas de 2",en:"Two-level openings"}, hands:[{ label:{es:"Fuerte → 2♣",en:"Strong → 2♣"}, showHCP:true, h:{"♠":"AKQJ8","♥":"AK7","♦":"AT5","♣":"K3"} },{ label:{es:"Débil → 2♥",en:"Weak → 2♥"}, showHCP:true, h:{"♠":"4","♥":"KQT973","♦":"982","♣":"J65"} }], note:{es:"La 1ª (24 PH) abre 2♣ artificial y forcing. La 2ª (6 PH, 6 cartas) abre 2♥ débil para estorbar.",en:"The 1st (24 HCP) opens an artificial forcing 2♣. The 2nd (6 HCP, 6 cards) opens a weak 2♥ to obstruct."} }], t: { es: "Aperturas de 2: fuertes y débiles", en: "2-level openings: strong and weak" },
      ...
      { id: "l2k", ex: [{ t:{es:"Invitar (2ST)",en:"Inviting (2NT)"}, hands:[{ label:{es:"Compañero abrió 1ST",en:"Partner opened 1NT"}, showHCP:true, h:{"♠":"KJ5","♥":"QT62","♦":"K94","♣":"J83"} }], note:{es:"Con 10 puntos justos invitas con 2ST: el abridor pasa con 15 o sube a 3ST con 16-17.",en:"With exactly 10 points invite with 2NT: opener passes with 15 or bids 3NT with 16-17."} }], t: { es: "Forcing, invitacional y cierre", en: "Forcing, invitational and signoff" },
      ...
      { id: "l2l", ex: [{ t:{es:"Competir: overcall y contra",en:"Competing: overcall & double"}, hands:[{ label:{es:"Overcall → 1♠",en:"Overcall → 1♠"}, showHCP:true, h:{"♠":"AQT83","♥":"K5","♦":"J94","♣":"Q62"} },{ label:{es:"Contra informativo",en:"Takeout double"}, showHCP:true, h:{"♠":"KJ85","♥":"AQ73","♦":"4","♣":"KT62"} }], note:{es:"Sobre (1♦): la 1ª interviene 1♠ (5 cartas, buen palo). La 2ª dobla (informativo): corto en ♦ y apoyo en los demás.",en:"Over (1♦): the 1st overcalls 1♠ (5 good cards). The 2nd doubles (takeout): short in ♦, support for the others."} }], t: { es: "Competir: overcalls y contra informativo", en: "Competing: overcalls and takeout double" },
  ...
  },
  {
    ...
    dealsTarget: 80,
    lessons: [
      { id: "l3a", ex: [{ t:{es:"2/1 forcing de manga",en:"2/1 game force"}, hands:[{ label:{es:"Compañero abrió 1♠",en:"Partner opened 1♠"}, showHCP:true, h:{"♠":"A4","♥":"KQT62","♦":"AT5","♣":"K83"} }], note:{es:"16 puntos y 5 corazones: responde 2♥. Es 2/1, forcing a manga: hay sitio para describir despacio.",en:"16 points and 5 hearts: respond 2♥. That's 2/1, game-forcing: room to describe shape slowly."} }], t: { es: "2/1 forzando a manga", en: "2/1 game forcing" },
      ...
      { id: "l3b", ex: [{ t:{es:"Jacoby 2ST",en:"Jacoby 2NT"}, hands:[{ label:{es:"Compañero abrió 1♠",en:"Partner opened 1♠"}, showHCP:true, h:{"♠":"KQ75","♥":"A4","♦":"KJT62","♣":"83"} }], note:{es:"Apoyo de 4 picas y mano de manga+: 2ST (Jacoby) pide al abridor mostrar cortos para buscar slam.",en:"4-spade support and game-plus values: 2NT (Jacoby) asks opener to show shortness to explore slam."} }], t: { es: "Apoyos fuertes: Jacoby 2ST y splinters", en: "Strong raises: Jacoby 2NT and splinters" },
      ...
      { id: "l3c", ex: [{ t:{es:"Blackwood (4ST)",en:"Blackwood (4NT)"}, hands:[{ label:{es:"Mano con ajuste",en:"Hand with a fit"}, showHCP:true, h:{"♠":"AKQT73","♥":"A4","♦":"KQ5","♣":"32"} }], note:{es:"Con el ajuste hallado y interés de slam, 4ST pregunta cuántas cartas clave (ases + rey de triunfo) tiene el compañero.",en:"With a fit and slam interest, 4NT asks how many key cards (aces + trump king) partner holds."} }], t: { es: "Preguntas de ases: Blackwood y Gerber", en: "Ace-asking: Blackwood and Gerber" },
      ...
      { id: "l3d", ex: [{ t:{es:"Cue-bid (control)",en:"Cue bid (control)"}, hands:[{ label:{es:"Tras 1♠–3♠",en:"After 1♠–3♠"}, showHCP:true, h:{"♠":"AQT62","♥":"KQ5","♦":"A4","♣":"K83"} }], note:{es:"Acordado el palo, 4♣ es un cue-bid: muestra el control de ♣ (as o corto) camino del slam.",en:"With the suit agreed, 4♣ is a cue bid: it shows the ♣ control (ace or shortness) en route to slam."} }], t: { es: "Cue bids y controles", en: "Cue bids and controls" },
      ...
      { id: "l3e", ex: [{ t:{es:"Doblo negativo",en:"Negative double"}, hands:[{ label:{es:"Tras 1♦–(1♠)",en:"After 1♦–(1♠)"}, showHCP:true, h:{"♠":"KJ73","♥":"AT62","♦":"95","♣":"Q84"} }], note:{es:"No puedes pujar 2♥ con tan poco; el doblo muestra los mayores no pujados (4 corazones) y valores.",en:"You can't bid 2♥ this weak; the double shows the unbid major(s) (4 hearts) and values."} }], t: { es: "Doblos en competición", en: "Doubles in competition" },
      ...
      { id: "l3f", ex: [{ t:{es:"Cue-bid Michaels",en:"Michaels cue bid"}, hands:[{ label:{es:"Sobre (1♦)",en:"Over (1♦)"}, showHCP:true, h:{"♠":"KQT62","♥":"AJ983","♦":"5","♣":"74"} }], note:{es:"Bicolor 5-5 en mayores: en vez de pujar un palo, 2♦ (Michaels) enseña los dos a la vez.",en:"A 5-5 two-suiter in the majors: instead of one suit, 2♦ (Michaels) shows both at once."} }], t: { es: "Intervenciones de dos palos", en: "Two-suited overcalls" },
      ...
      { id: "l3g", ex: [{ t:{es:"Invitar o forzar",en:"Invite or force"}, hands:[{ label:{es:"Tras 1♠ con ajuste",en:"After 1♠ with a fit"}, showHCP:true, h:{"♠":"KT62","♥":"AQ7","♦":"K984","♣":"83"} }], note:{es:"12 puntos con ajuste: no es manga segura. Invita con 3♠ y deja que el abridor decida con su máximo.",en:"12 points with a fit: game isn't certain. Invite with 3♠ and let opener decide with a maximum."} }], t: { es: "Invitar o forzar: medir la manga", en: "Invite or force: judging game" },
  ...
  },
  {
    ...
    dealsTarget: 90,
    lessons: [
      { id: "l4a", ex: [{ t:{es:"El plan: ganadoras y perdedoras",en:"The plan: winners & losers"}, hands:[{ label:{es:"Declarante",en:"Declarer"}, h:{"♠":"AKT43","♥":"K5","♦":"A872","♣":"64"} },{ label:{es:"Muerto",en:"Dummy"}, h:{"♠":"Q762","♥":"A83","♦":"K54","♣":"952"} }], note:{es:"En 4♠ cuenta perdedoras: ♠ 0, ♥ 1, ♦ 1, ♣ 2 = 4. Plan: descarta un ♣ sobre el ♥ largo y falla el otro. Haz el plan antes de la baza 1.",en:"In 4♠ count losers: ♠ 0, ♥ 1, ♦ 1, ♣ 2 = 4. Plan: discard one ♣ on a long ♥ and ruff the other. Plan before trick 1."} }], t: { es: "El plan del carteo", en: "The declarer's plan" },
      ...
      { id: "l4b", ex: [{ t:{es:"¿Sacar triunfos ya?",en:"Draw trumps now?"}, hands:[{ label:{es:"Declarante",en:"Declarer"}, h:{"♠":"AKQ54","♥":"AT72","♦":"K5","♣":"83"} },{ label:{es:"Muerto",en:"Dummy"}, h:{"♠":"J32","♥":"6","♦":"A8732","♣":"QT94"} }], note:{es:"El muerto tiene singleton ♥. Si sacas triunfos primero, ya no podrás fallar tus ♥ allí. Falla una o dos primero y luego saca triunfos.",en:"Dummy has a singleton ♥. If you draw trumps first you can't ruff your hearts there. Ruff one or two first, then draw trumps."} }], t: { es: "Sacar triunfos: cuándo sí y cuándo no", en: "Drawing trumps: when and when not" },
      ...
      { id: "l4c", ex: [{ t:{es:"El impasse",en:"The finesse"}, hands:[{ label:{es:"Muerto (mira ♠)",en:"Dummy (look at ♠)"}, h:{"♠":"AQ5","♥":"832","♦":"Q76","♣":"9543"} },{ label:{es:"Declarante",en:"Declarer"}, h:{"♠":"763","♥":"AK4","♦":"AK52","♣":"A52"} }], note:{es:"Sal del ♠7 hacia la A-Q del muerto y juega la Q. Gana si el ♠K está a tu izquierda: una baza extra el 50% de las veces.",en:"Lead the ♠7 toward dummy's A-Q and play the queen. It wins if the ♠K is on your left: an extra trick half the time."} }], t: { es: "El impasse (finesse)", en: "The finesse" },
      ...
      { id: "l4d", ex: [{ t:{es:"Establecer un palo largo",en:"Establishing a long suit"}, hands:[{ label:{es:"Declarante",en:"Declarer"}, h:{"♠":"A8","♥":"K762","♦":"72","♣":"AKQ54"} },{ label:{es:"Muerto (mira ♦)",en:"Dummy (look at ♦)"}, h:{"♠":"K54","♥":"A83","♦":"AK543","♣":"62"} }], note:{es:"Cobra ♦A y ♦K y cede una ronda; el 5-4-3 del muerto se vuelve ganador. Reserva una entrada (♠K, ♥A) para alcanzarlo.",en:"Cash ♦A and ♦K and concede a round; dummy's 5-4-3 become winners. Keep an entry (♠K, ♥A) to reach them."} }], t: { es: "Establecer un palo largo", en: "Establishing a long suit" },
      ...
      { id: "l4e", ex: [{ t:{es:"Cruz de fallos",en:"Crossruff"}, hands:[{ label:{es:"Declarante",en:"Declarer"}, h:{"♠":"AKQ72","♥":"A6","♦":"84","♣":"A632"} },{ label:{es:"Muerto",en:"Dummy"}, h:{"♠":"4","♥":"KQ753","♦":"AK52","♣":"942"} }], note:{es:"Con cortos opuestos puedes fallar ♥ en tu mano y ♦/♠ en el muerto alternando: cobra primero los ases laterales y luego cruza fallos.",en:"With matching shortness you can ruff ♥ in hand and ♦/♠ in dummy alternately: cash side aces first, then crossruff."} }], t: { es: "Fallar en el muerto y cruz de fallos", en: "Ruffing in dummy and the cross-ruff" },
      ...
      { id: "l4f", ex: [{ t:{es:"Hold-up en Sin Triunfo",en:"Hold-up in Notrump"}, hands:[{ label:{es:"Declarante",en:"Declarer"}, h:{"♠":"A72","♥":"AK4","♦":"KQJ95","♣":"83"} },{ label:{es:"Muerto",en:"Dummy"}, h:{"♠":"643","♥":"Q82","♦":"AT7","♣":"A642"} }], note:{es:"Te salen ♠ y solo tienes el ♠A. Aguántalo hasta la 3ª ronda: así, cuando cedas el ♦, el rival peligroso ya no tendrá ♠ para cobrar.",en:"They lead ♠ and you have just the ♠A. Hold it up until the third round: when you later lose the ♦, the danger hand has no ♠ to cash."} }], t: { es: "Hold-up y control en Sin Triunfo", en: "Hold-up and control in Notrump" },
      ...
      { id: "l4g", ex: [{ t:{es:"Jugada de seguridad",en:"Safety play"}, hands:[{ label:{es:"Declarante (mira ♥)",en:"Declarer (look at ♥)"}, h:{"♠":"A4","♥":"AKJ52","♦":"K73","♣":"642"} },{ label:{es:"Muerto",en:"Dummy"}, h:{"♠":"K763","♥":"743","♦":"A85","♣":"Q92"} }], note:{es:"Falta la ♥Q. Para no perder más de una, cobra primero el ♥A (cae la Q seca a la derecha); si no, vuelve y haz el impasse del ♥J.",en:"The ♥Q is missing. To lose at most one, cash the ♥A first (a singleton Q drops on your right); otherwise cross back and finesse the ♥J."} }], t: { es: "Entradas, seguridad y conteo", en: "Entries, safety plays and counting" },
      ...
      { id: "l4h", ex: [{ t:{es:"Loser-on-loser",en:"Loser-on-loser"}, hands:[{ label:{es:"Declarante",en:"Declarer"}, h:{"♠":"AKQJ6","♥":"5","♦":"A432","♣":"K42"} },{ label:{es:"Muerto",en:"Dummy"}, h:{"♠":"7532","♥":"A4","♦":"KQ5","♣":"8763"} }], note:{es:"Cuando un rival ataca un palo, a veces conviene descartar una perdedora sobre otra (loser-on-loser): ganas tempo o evitas que entre la mano peligrosa.",en:"When an opponent attacks, sometimes discard a loser on a loser: you gain tempo or keep the danger hand off lead."} }], t: { es: "Loser-on-loser y avoidance", en: "Loser-on-loser and avoidance" },
  ...
  },
  {
    ...
    dealsTarget: 90,
    lessons: [
      { id: "l5a", ex: [{ t:{es:"La squeeze",en:"The squeeze"}, hands:[{ label:{es:"Amenazas (declarante)",en:"Threats (declarer)"}, h:{"♠":"A4","♥":"AKQ5","♦":"AK3","♣":"432"} }], note:{es:"Con amenazas en dos palos que solo un rival guarda, cobra tus ganadoras hasta la última: ese rival no podrá conservar ambos palos y soltará un guardián.",en:"With threats in two suits only one opponent guards, cash your winners to the last: that opponent can't keep both and must release a guard."} }], t: { es: "La squeeze (compresión)", en: "The squeeze" },
      ...
      { id: "l5b", ex: [{ t:{es:"Eliminación y endplay",en:"Elimination & endplay"}, hands:[{ label:{es:"Tenaza (mira ♣)",en:"Tenace (look at ♣)"}, h:{"♠":"A","♥":"A2","♦":"A2","♣":"AQ5432"} }], note:{es:"Elimina los palos seguros del rival y cédele una baza forzada: obligado, debe abrir ♣ hacia tu A-Q o darte fallo y descarte.",en:"Strip the opponent's safe suits and force them in: stuck, they must lead ♣ into your A-Q or give a ruff-and-discard."} }], t: { es: "Eliminación y endplay", en: "Elimination and endplay" },
      ...
      { id: "l5c", ex: [{ t:{es:"Coup de triunfo",en:"Trump coup"}, hands:[{ label:{es:"Posición de coup",en:"Coup position"}, h:{"♠":"AQ","♥":"3","♦":"2","♣":"AKQJ9"} }], note:{es:"Cuando un rival tiene Jx de triunfo tras de ti y no puedes hacer el impasse, acorta tus triunfos con fallos hasta quedar en posición de 'coup': le ganas la jota sin impasse.",en:"When an opponent has Jx of trumps behind you and you can't finesse, shorten your trumps by ruffing until you reach a 'coup' position: you capture the jack without a finesse."} }], t: { es: "Coups de triunfo", en: "Trump coups" },
      ...
      { id: "l5d", ex: [{ t:{es:"Dummy reversal",en:"Dummy reversal"}, hands:[{ label:{es:"Declarante",en:"Declarer"}, h:{"♠":"AKQ6","♥":"A72","♦":"A72","♣":"K43"} },{ label:{es:"Muerto",en:"Dummy"}, h:{"♠":"JT93","♥":"K43","♦":"K43","♣":"A52"} }], note:{es:"A veces ganas una baza extra fallando en tu mano larga de triunfo y sacando triunfos desde el muerto: inviertes los papeles (dummy reversal).",en:"Sometimes you gain a trick by ruffing in your long trump hand and drawing trumps from dummy: you swap the roles (dummy reversal)."} }], t: { es: "Dummy reversal", en: "The dummy reversal" },
      ...
      { id: "l5e", ex: [{ t:{es:"Defensa: la salida",en:"Defense: the lead"}, hands:[{ label:{es:"Tu mano (defensa)",en:"Your hand (defender)"}, h:{"♠":"KQT62","♥":"84","♦":"A95","♣":"762"} }], note:{es:"Contra 3ST sal del ♠K (cima de la secuencia K-Q-T): es seguro y empieza a establecer tu palo largo de 5 cartas.",en:"Against 3NT lead the ♠K (top of the K-Q-T sequence): it's safe and starts to establish your 5-card suit."} }], t: { es: "Defensa: la salida (lead)", en: "Defence: the opening lead" },
      ...
      { id: "l5f", ex: [{ t:{es:"Defensa: señales",en:"Defense: signals"}, hands:[{ label:{es:"Tu mano (defensa)",en:"Your hand (defender)"}, h:{"♠":"863","♥":"A5","♦":"KQ97","♣":"T842"} }], note:{es:"Cuando el compañero sale, tu carta es un mensaje: alta = me gusta el palo (actitud); alta-luego-baja = par (cuenta). Tus cartas pequeñas guían a tu compañero.",en:"When partner leads, your card is a message: high = I like the suit (attitude); high-then-low = even count. Your spot cards guide partner."} }], t: { es: "Defensa: señales", en: "Defence: signals" },
      ...
      { id: "l5g", ex: [{ t:{es:"Defensa: técnica de cartón",en:"Defense: card technique"}, hands:[{ label:{es:"Tu mano (defensa)",en:"Your hand (defender)"}, h:{"♠":"KJ4","♥":"9752","♦":"A83","♣":"Q96"} }], note:{es:"Reglas de oro: en segunda mano juega bajo; en tercera mano juega alto; cubre un honor con un honor cuando promueva tus cartas.",en:"Golden rules: second hand low; third hand high; cover an honor with an honor when it promotes your cards."} }], t: { es: "Defensa: técnica de cartón", en: "Defence: card technique" },
      ...
      { id: "l5h", ex: [{ t:{es:"Probabilidades y estrategia",en:"Odds & strategy"}, hands:[{ label:{es:"Mira ♥ (las dos manos)",en:"Look at ♥ (both hands)"}, h:{"♠":"5","♥":"AKT98","♦":"432","♣":"AK32"} }], note:{es:"Falta la ♥Q con 9 cartas: 'ocho seguro, nueve impasse' sugiere jugar a la caída con 9 si no hay pista. Cuenta el reparto y las señales antes de decidir.",en:"Missing the ♥Q with 9 cards: 'eight ever, nine never' suggests playing for the drop with 9 absent other clues. Count the distribution and signals before deciding."} }], t: { es: "Probabilidades y estrategia", en: "Probabilities and strategy" },
...
function PlayingCard({ card, onClick, dim, small, hidden }) {
  const sc = UI.cardScale || 1;
  const w = Math.round((small ? 36 : 48) * sc), h = Math.round((small ? 50 : 66) * sc);
  if (hidden) {
  ...
  return (
    <button onClick={onClick} disabled={!onClick}
      ...
      <span style={{ fontSize: Math.round((small ? 16 : 20) * sc) }}>{card.r}</span>
      <span style={{ fontSize: Math.round((small ? 17 : 22) * sc) }}>{card.s}</span>
    </button>
  );
}
...
// ---------- Example hand diagram (for lessons) ----------
const HCP_MAP = { A: 4, K: 3, Q: 2, J: 1 };
function HandDiagram({ hand, label, showHCP, sub }) {
  const order = ["♠", "♥", "♦", "♣"];
  let hcp = 0, len = 0;
  order.forEach(s => { (hand[s] || "").split("").forEach(r => { hcp += HCP_MAP[r] || 0; len++; }); });
  const shape = order.map(s => (hand[s] || "").length).join("-");
  return (
    <div style={{ background: C.feltLite, border: `1px solid ${C.brassDim}`, borderRadius: 10 }} className="p-3">
      {label && <div className="flex items-center justify-between mb-1"><span style={{ color: C.brass }} className="text-xs font-bold uppercase">{label}</span>{showHCP && <span style={{ color: C.ivory }} className="text-xs font-semibold">{hcp} {hcp === 1 ? "PH" : "PH"} · {shape}</span>}</div>}
      <div className="flex flex-col gap-0.5">
        {order.map(s => (
          <div key={s} className="flex items-center gap-2">
            <span style={{ width: 16, color: SUIT_RED.has(s) ? C.red : C.ivory }} className="text-base">{s}</span>
            <span style={{ color: SUIT_RED.has(s) ? C.red : C.ivory, letterSpacing: 2 }} className="text-[15px] font-semibold">
              {(hand[s] || "—").replace(/T/g, "10").replace(/(10|[AKQJ2-9])/g, "$1 ").trim() || "—"}
            </span>
          </div>
        ))}
      </div>
      {sub && <p style={{ color: C.soft }} className="text-xs mt-1.5">{sub}</p>}
    </div>
  );
}

function LessonView({ level, lang, status, onMark, onPractice }) {
  ...
  return (
    <div>
      ...
      <div style={{ background: C.feltDark, border: `1px solid ${C.line}`, borderRadius: 12 }} className="p-5">
        ...
        {lesson.ex && lesson.ex.map((ex, xi) => (
          <div key={xi} style={{ background: C.feltDark, border: `1px solid ${C.brassDim}`, borderRadius: 10 }} className="mt-4 p-3 flex flex-col gap-2">
            <div style={{ color: C.brass }} className="text-xs font-bold uppercase">{T[lang].example}: {ex.t[lang]}</div>
            <div className="flex flex-col gap-2">
              {ex.hands.map((hd, hi) => <HandDiagram key={hi} hand={hd.h} label={typeof hd.label === "string" ? hd.label : (hd.label ? hd.label[lang] : null)} showHCP={hd.showHCP} sub={hd.sub ? hd.sub[lang] : null} />)}
            </div>
            {ex.note && <p style={{ color: C.ivory }} className="text-sm leading-relaxed">{ex.note[lang]}</p>}
          </div>
        ))}
        <div className="flex items-center gap-2 mt-5 flex-wrap">
          ...
          {onPractice && <button onClick={() => onPractice(level.id)} style={{ background: C.brass, color: C.ink }} className="px-3 py-1.5 rounded text-sm font-semibold flex items-center gap-1"><Play size={14} />{T[lang].seeReal}</button>}
...
function reconstructPlay(card) {
  const hands = card.d ? decodeThemeDeal(card.d) : { N: card.hands.N.slice(), E: card.hands.E.slice(), S: card.hands.S.slice(), W: card.hands.W.slice() };
...
function PlayPractice({ deal, lang, onComplete, onExit, title, onCaptureLead, onCapturePlay, onLog }) {
  ...
  const runAnalysis = () => {
    ...
    const captureFindings = (res) => {
      if ((!AD.d && !AD.hands) || !onCapturePlay || !res || !res.findings) return;
      for (const fd of res.findings) {
        if (fd.ply == null || !fd.bestCards || !fd.bestCards.length) continue;
        onCapturePlay({ ...(AD.d ? { d: AD.d } : { hands: AD.hands }), contract: AD.contract, declarer, seq: g.played.slice(0, fd.ply), ply: fd.ply, seat: fd.seat, userCard: fd.card, bestCards: fd.bestCards, lost: fd.lost, trickNo: fd.trickNo });
      }
    };
...
function Dashboard({ lang, user, onOpenLevel, onQuickPlay, onGoReview, onTechniques, onConventions, onGuide }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <button onClick={onGuide} style={{ background: C.feltDark, color: C.ivory, border: `1px solid ${C.line}`, borderRadius: 12 }} className="p-3 flex items-center justify-between"><span className="flex items-center gap-2 font-bold"><BookOpen size={18} style={{ color: C.brass }} />{L.guideTitle}</span><ChevronRight size={18} style={{ color: C.brass }} /></button>
      ...
      <button onClick={onConventions} style={{ background: C.feltDark, color: C.ivory, border: `1px solid ${C.line}`, borderRadius: 12 }} className="p-3 flex items-center justify-between"><span className="flex items-center gap-2 font-bold"><Sparkles size={18} style={{ color: C.brass }} />{L.conventions}</span><ChevronRight size={18} style={{ color: C.brass }} /></button>
...
function LevelDetail({ levelId, lang, user, onBack, marks, onOpenDeal, initialTab }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div>
        {tab === "lessons" && <LessonView level={level} lang={lang} status={prog} onMark={(id, st) => marks.lesson(levelId, id, st)} onPractice={() => setTab(level.id <= 2 ? "bid" : "play")} />}
    ...
    <div className="flex flex-col gap-4">
      ...
      {tab === "learn" ? (
        <div className="flex flex-col gap-3">
          <div className="flex gap-1.5 flex-wrap">
            {LEVELS.map(lv => (
              <button key={lv.id} onClick={() => setLvSel(lv.id)} style={{ background: lvSel === lv.id ? C.feltLite : C.feltDark, color: lvSel === lv.id ? C.ivory : C.soft, border: `1px solid ${lvSel === lv.id ? C.brass : C.line}`, borderRadius: 8 }} className="px-3 py-1.5 text-xs font-semibold">{L.levelWord} {lv.id}</button>
            ))}
          </div>
...
const TECHNIQUES = [
  {
    key: "finesse", deal: { hands:{N:[{s:"♠",r:"A"},{s:"♠",r:"Q"},{s:"♠",r:"5"},{s:"♥",r:"8"},{s:"♥",r:"6"},{s:"♥",r:"4"},{s:"♦",r:"K"},{s:"♦",r:"Q"},{s:"♦",r:"5"},{s:"♣",r:"K"},{s:"♣",r:"8"},{s:"♣",r:"4"},{s:"♣",r:"2"}],E:[{s:"♠",r:"J"},{s:"♠",r:"T"},{s:"♠",r:"9"},{s:"♠",r:"8"},{s:"♠",r:"6"},{s:"♥",r:"J"},{s:"♥",r:"T"},{s:"♥",r:"3"},{s:"♥",r:"2"},{s:"♦",r:"T"},{s:"♦",r:"2"},{s:"♣",r:"J"},{s:"♣",r:"9"}],S:[{s:"♠",r:"7"},{s:"♠",r:"3"},{s:"♠",r:"2"},{s:"♥",r:"A"},{s:"♥",r:"K"},{s:"♥",r:"5"},{s:"♦",r:"A"},{s:"♦",r:"J"},{s:"♦",r:"6"},{s:"♣",r:"A"},{s:"♣",r:"7"},{s:"♣",r:"5"},{s:"♣",r:"3"}],W:[{s:"♠",r:"K"},{s:"♠",r:"4"},{s:"♥",r:"Q"},{s:"♥",r:"9"},{s:"♥",r:"7"},{s:"♦",r:"9"},{s:"♦",r:"8"},{s:"♦",r:"7"},{s:"♦",r:"4"},{s:"♦",r:"3"},{s:"♣",r:"Q"},{s:"♣",r:"T"},{s:"♣",r:"6"}]}, contract:{declarer:"S",strain:"ST",level:3}, seed:7 }, name: { es: "Impasse (finesse)", en: "Finesse" },
  ...
  {
    key: "holdup", deal: { hands:{N:[{s:"♠",r:"6"},{s:"♠",r:"4"},{s:"♠",r:"2"},{s:"♥",r:"A"},{s:"♥",r:"8"},{s:"♥",r:"3"},{s:"♦",r:"K"},{s:"♦",r:"Q"},{s:"♦",r:"J"},{s:"♦",r:"9"},{s:"♦",r:"5"},{s:"♣",r:"A"},{s:"♣",r:"4"}],E:[{s:"♠",r:"5"},{s:"♥",r:"J"},{s:"♥",r:"6"},{s:"♥",r:"2"},{s:"♦",r:"8"},{s:"♦",r:"3"},{s:"♦",r:"2"},{s:"♣",r:"J"},{s:"♣",r:"T"},{s:"♣",r:"9"},{s:"♣",r:"8"},{s:"♣",r:"7"},{s:"♣",r:"5"}],S:[{s:"♠",r:"A"},{s:"♠",r:"7"},{s:"♠",r:"3"},{s:"♥",r:"K"},{s:"♥",r:"Q"},{s:"♥",r:"5"},{s:"♦",r:"A"},{s:"♦",r:"T"},{s:"♦",r:"7"},{s:"♣",r:"K"},{s:"♣",r:"6"},{s:"♣",r:"3"},{s:"♣",r:"2"}],W:[{s:"♠",r:"K"},{s:"♠",r:"Q"},{s:"♠",r:"J"},{s:"♠",r:"T"},{s:"♠",r:"9"},{s:"♠",r:"8"},{s:"♥",r:"T"},{s:"♥",r:"9"},{s:"♥",r:"7"},{s:"♥",r:"4"},{s:"♦",r:"6"},{s:"♦",r:"4"},{s:"♣",r:"Q"}]}, contract:{declarer:"S",strain:"ST",level:3}, seed:7 }, name: { es: "Aguantar (holdup)", en: "Hold-up" },
  ...
  {
    key: "establish", deal: { hands:{N:[{s:"♠",r:"K"},{s:"♠",r:"5"},{s:"♠",r:"4"},{s:"♥",r:"A"},{s:"♥",r:"8"},{s:"♥",r:"3"},{s:"♦",r:"A"},{s:"♦",r:"K"},{s:"♦",r:"5"},{s:"♦",r:"4"},{s:"♦",r:"3"},{s:"♣",r:"6"},{s:"♣",r:"2"}],E:[{s:"♠",r:"Q"},{s:"♠",r:"J"},{s:"♠",r:"T"},{s:"♠",r:"9"},{s:"♠",r:"7"},{s:"♠",r:"3"},{s:"♥",r:"9"},{s:"♥",r:"5"},{s:"♥",r:"4"},{s:"♦",r:"Q"},{s:"♦",r:"J"},{s:"♦",r:"T"},{s:"♣",r:"8"}],S:[{s:"♠",r:"A"},{s:"♠",r:"8"},{s:"♥",r:"K"},{s:"♥",r:"7"},{s:"♥",r:"6"},{s:"♥",r:"2"},{s:"♦",r:"7"},{s:"♦",r:"2"},{s:"♣",r:"A"},{s:"♣",r:"K"},{s:"♣",r:"Q"},{s:"♣",r:"5"},{s:"♣",r:"4"}],W:[{s:"♠",r:"6"},{s:"♠",r:"2"},{s:"♥",r:"Q"},{s:"♥",r:"J"},{s:"♥",r:"T"},{s:"♦",r:"9"},{s:"♦",r:"8"},{s:"♦",r:"6"},{s:"♣",r:"J"},{s:"♣",r:"T"},{s:"♣",r:"9"},{s:"♣",r:"7"},{s:"♣",r:"3"}]}, contract:{declarer:"S",strain:"♣",level:5}, seed:7 }, name: { es: "Establecer un palo largo", en: "Establishing a long suit" },
  ...
  {
    key: "safety", deal: { hands:{N:[{s:"♠",r:"K"},{s:"♠",r:"7"},{s:"♠",r:"6"},{s:"♠",r:"3"},{s:"♥",r:"7"},{s:"♥",r:"4"},{s:"♥",r:"3"},{s:"♦",r:"A"},{s:"♦",r:"8"},{s:"♦",r:"5"},{s:"♣",r:"Q"},{s:"♣",r:"9"},{s:"♣",r:"2"}],E:[{s:"♠",r:"T"},{s:"♠",r:"8"},{s:"♠",r:"2"},{s:"♥",r:"Q"},{s:"♥",r:"T"},{s:"♥",r:"9"},{s:"♥",r:"6"},{s:"♦",r:"J"},{s:"♦",r:"T"},{s:"♣",r:"T"},{s:"♣",r:"7"},{s:"♣",r:"4"},{s:"♣",r:"3"}],S:[{s:"♠",r:"A"},{s:"♠",r:"4"},{s:"♥",r:"A"},{s:"♥",r:"K"},{s:"♥",r:"J"},{s:"♥",r:"5"},{s:"♥",r:"2"},{s:"♦",r:"K"},{s:"♦",r:"7"},{s:"♦",r:"3"},{s:"♣",r:"K"},{s:"♣",r:"6"},{s:"♣",r:"5"}],W:[{s:"♠",r:"Q"},{s:"♠",r:"J"},{s:"♠",r:"9"},{s:"♠",r:"5"},{s:"♥",r:"8"},{s:"♦",r:"Q"},{s:"♦",r:"9"},{s:"♦",r:"6"},{s:"♦",r:"4"},{s:"♦",r:"2"},{s:"♣",r:"A"},{s:"♣",r:"J"},{s:"♣",r:"8"}]}, contract:{declarer:"S",strain:"♥",level:4}, seed:7 }, name: { es: "Jugada de seguridad", en: "Safety play" },
  ...
  {
    key: "endplay", deal: { hands:{N:[{s:"♠",r:"Q"},{s:"♠",r:"7"},{s:"♠",r:"2"},{s:"♥",r:"K"},{s:"♥",r:"8"},{s:"♥",r:"4"},{s:"♦",r:"A"},{s:"♦",r:"5"},{s:"♦",r:"3"},{s:"♣",r:"Q"},{s:"♣",r:"7"},{s:"♣",r:"6"},{s:"♣",r:"2"}],E:[{s:"♠",r:"T"},{s:"♠",r:"8"},{s:"♠",r:"4"},{s:"♥",r:"9"},{s:"♥",r:"3"},{s:"♦",r:"Q"},{s:"♦",r:"J"},{s:"♦",r:"T"},{s:"♦",r:"8"},{s:"♦",r:"6"},{s:"♦",r:"4"},{s:"♣",r:"J"},{s:"♣",r:"8"}],S:[{s:"♠",r:"A"},{s:"♠",r:"K"},{s:"♠",r:"J"},{s:"♠",r:"9"},{s:"♠",r:"6"},{s:"♠",r:"3"},{s:"♥",r:"A"},{s:"♥",r:"5"},{s:"♦",r:"K"},{s:"♦",r:"7"},{s:"♦",r:"2"},{s:"♣",r:"A"},{s:"♣",r:"5"}],W:[{s:"♠",r:"5"},{s:"♥",r:"Q"},{s:"♥",r:"J"},{s:"♥",r:"T"},{s:"♥",r:"7"},{s:"♥",r:"6"},{s:"♥",r:"2"},{s:"♦",r:"9"},{s:"♣",r:"K"},{s:"♣",r:"T"},{s:"♣",r:"9"},{s:"♣",r:"4"},{s:"♣",r:"3"}]}, contract:{declarer:"S",strain:"♠",level:4}, seed:7 }, name: { es: "Jugada de fin (endplay)", en: "Endplay / throw-in" },
  ...
  {
    key: "squeeze", deal: { hands:{N:[{s:"♠",r:"A"},{s:"♠",r:"4"},{s:"♥",r:"A"},{s:"♥",r:"3"},{s:"♥",r:"2"},{s:"♦",r:"A"},{s:"♦",r:"K"},{s:"♦",r:"3"},{s:"♦",r:"2"},{s:"♣",r:"7"},{s:"♣",r:"6"},{s:"♣",r:"5"},{s:"♣",r:"4"}],E:[{s:"♠",r:"J"},{s:"♠",r:"T"},{s:"♠",r:"7"},{s:"♠",r:"3"},{s:"♥",r:"9"},{s:"♥",r:"8"},{s:"♥",r:"7"},{s:"♦",r:"9"},{s:"♦",r:"7"},{s:"♦",r:"5"},{s:"♣",r:"J"},{s:"♣",r:"9"},{s:"♣",r:"3"}],S:[{s:"♠",r:"K"},{s:"♠",r:"Q"},{s:"♠",r:"5"},{s:"♥",r:"K"},{s:"♥",r:"Q"},{s:"♥",r:"4"},{s:"♦",r:"Q"},{s:"♦",r:"J"},{s:"♦",r:"4"},{s:"♣",r:"A"},{s:"♣",r:"K"},{s:"♣",r:"Q"},{s:"♣",r:"2"}],W:[{s:"♠",r:"9"},{s:"♠",r:"8"},{s:"♠",r:"6"},{s:"♠",r:"2"},{s:"♥",r:"J"},{s:"♥",r:"T"},{s:"♥",r:"6"},{s:"♥",r:"5"},{s:"♦",r:"T"},{s:"♦",r:"8"},{s:"♦",r:"6"},{s:"♣",r:"T"},{s:"♣",r:"8"}]}, contract:{declarer:"S",strain:"ST",level:6}, seed:7 }, name: { es: "Presión (squeeze)", en: "Squeeze" },
...
function TechniquesView({ lang, onPlay }) {
  const L = T[lang];
  const [sel, setSel] = useState(null);
  if (sel != null) {
    ...
    return (
      <div className="flex flex-col gap-3">
        ...
        {tq.deal && onPlay && (
          <button onClick={() => onPlay(tq.deal, tq.name[lang])} style={{ background: C.brass, color: C.ink, borderRadius: 12 }} className="p-3 font-semibold flex items-center justify-center gap-2">
            <Play size={16} />{L.practiceReal}
            <span style={{ color: C.ink, opacity: 0.7 }} className="text-xs font-normal">· {tq.deal.contract.level}{tq.deal.contract.strain === "ST" ? "ST" : tq.deal.contract.strain} ✓DD</span>
          </button>
        )}
      </div>
    );
...
const CONVENTIONS = [
  ...
  },
  {
    ...
    ex: { auction: "1♥ – 2NT", note: { es: "Apoyo de 4+ ♥, fuerza de manga, pide cortos.", en: "4+ ♥ support, game values, asks for shortness." } },
  },
];
...
function ConventionsView({ lang, onBid }) {
  ...
  if (sel != null) {
    ...
    return (
      <div className="flex flex-col gap-3">
        <button onClick={() => setSel(null)} style={{ color: C.brass }} className="text-sm flex items-center gap-1 self-start"><ChevronLeft size={16} />{L.back}</button>
        <SectionTitle icon={Sparkles}>{cv.name[lang]}</SectionTitle>
        <div style={{ background: C.feltDark, border: `1px solid ${C.line}`, borderRadius: 12 }} className="p-3">
          <div style={{ color: C.brass }} className="text-xs font-bold uppercase mb-1">{L.cvShows}</div>
          <p style={{ color: C.ivory }} className="text-sm">{cv.shows[lang]}</p>
        </div>
        <div style={{ background: C.feltLite, border: `1px solid ${C.brassDim}`, borderRadius: 12 }} className="p-3 flex flex-col gap-1">
          <div style={{ color: C.brass }} className="text-xs font-bold uppercase mb-1">{L.cvExample}</div>
          <div style={{ color: C.ivory }} className="text-base font-bold tracking-wider">{cv.ex.auction}</div>
          <div style={{ color: C.soft }} className="text-xs">{cv.ex.note[lang]}</div>
        </div>
        <div style={{ background: C.feltDark, border: `1px solid ${C.line}`, borderRadius: 12 }} className="p-3">
          <div style={{ color: C.brass }} className="text-xs font-bold uppercase mb-1">{L.cvWhen}</div>
          <p style={{ color: C.ivory }} className="text-sm">{cv.when[lang]}</p>
        </div>
        <div style={{ background: C.feltDark, border: `1px solid ${C.line}`, borderRadius: 12 }} className="p-3">
          <div style={{ color: C.brass }} className="text-xs font-bold uppercase mb-2">{L.cvKeys}</div>
          <ul className="flex flex-col gap-1.5">
            {cv.points[lang].map((p, i) => (
              <li key={i} className="flex gap-2 text-sm" style={{ color: C.ivory }}>
                <span style={{ color: C.brass }} className="flex-shrink-0">•</span><span>{p}</span>
              </li>
            ))}
          </ul>
        </div>
  ...
  return (
    <div className="flex flex-col gap-3">
      <SectionTitle icon={Sparkles}>{L.conventions}</SectionTitle>
      <p style={{ color: C.soft }} className="text-sm">{L.conventionsSub}</p>
      <div className="flex flex-col gap-2">
        {CONVENTIONS.map((cv, i) => (
          <button key={cv.key} onClick={() => setSel(i)} style={{ background: C.feltDark, border: `1px solid ${C.line}`, borderRadius: 12 }} className="p-3 text-left flex items-center justify-between">
            <div className="flex-1 pr-2">
              <div style={{ color: C.ivory }} className="font-serif">{cv.name[lang]}</div>
              <div style={{ color: C.brass }} className="text-xs mt-0.5 font-bold tracking-wide">{cv.ex.auction}</div>
            </div>
            <ChevronRight size={18} style={{ color: C.brass }} />
          </button>
        ))}
...
function GuideView({ lang, user, onOpenLevel }) {
  const L = T[lang];
  const e = user.exp;
  const steps = L.guideSteps;
  return (
    <div className="flex flex-col gap-3">
      <SectionTitle icon={BookOpen}>{L.guideTitle}</SectionTitle>
      <div style={{ background: C.feltDark, border: `1px solid ${C.brassDim}`, borderRadius: 12 }} className="p-3 flex flex-col gap-2">
        <p style={{ color: C.ivory }} className="text-sm">{L.guideIntro}</p>
      ...
      {LEVELS.map(lv => {
        ...
        const unlocked = levelUnlocked(lv.id, user, e);
        return (
          <div key={lv.id} style={{ background: C.feltDark, border: `1px solid ${C.line}`, borderRadius: 12 }} className="p-3">
            <div className="flex items-center justify-between mb-1">
              <span style={{ color: C.ivory }} className="font-serif">{lv.name[lang]}</span>
              <span className="flex items-center gap-2">
                <span style={{ color: C.brass }} className="text-xs font-bold">{m.pct}%</span>
                <button onClick={() => unlocked && onOpenLevel(lv.id)} disabled={!unlocked} style={{ background: unlocked ? C.brass : C.line2, color: unlocked ? C.ink : C.soft, borderRadius: 8 }} className="px-2 py-1 text-xs font-semibold">{unlocked ? L.open : L.locked}</button>
              </span>
            </div>
            <p style={{ color: C.soft }} className="text-xs mb-2">{lv.sub[lang]}</p>
            <ul className="flex flex-col gap-1">
              {lv.lessons.map(ls => (
                <li key={ls.id} className="flex gap-2 text-sm" style={{ color: C.ivory }}><span style={{ color: C.brass }} className="flex-shrink-0">›</span><span>{ls.t[lang]}</span></li>
              ))}
            </ul>
          </div>
        );
...
function canDecodeReview(card) {
  try {
    if (card.type === "play" && card.hands && !card.d) return !!(card.hands.N && card.hands.E && card.hands.S && card.hands.W && card.hands.N.length);
    const h = decodeThemeDeal(card.d); return !!(h && h.N && h.E && h.S && h.W && h.N.length);
  } catch (e) { return false; }
}
function ReviewView({ lang, reviews, onGrade }) {
  const L = T[lang];
  const [queue] = useState(() => (reviews || []).filter(c => (c.due || 0) <= Date.now() && canDecodeReview(c)).sort((a, b) => (a.due || 0) - (b.due || 0)));
...
export default function App() {
  ...
  const marks = {
    ...
    capturePlay(item) {
      updateUser(u => {
        const reviews = (u.reviews || []).slice();
        const sig = item.d || (item.hands ? ["N", "E", "S", "W"].map(p => (item.hands[p] || []).map(c => c.s + c.r).join("")).join("") : "x");
        const id = "play:" + sig + ":" + item.ply;
  ...
  return (
    <div style={{ background: UI.page || `radial-gradient(circle at 50% 0%, ${C.felt}, ${C.feltDark} 80%)`, minHeight: "100vh", fontFamily: "ui-sans-serif, system-ui, sans-serif" }}>
      ...
      <div className={`${UI.maxW} mx-auto px-3 py-4 pb-24`}>
        ...
        {view.name === "conventions" && <ConventionsView lang={lang} onBid={() => setView({ name: "bid", params: {} })} />}
        {view.name === "guide" && <GuideView lang={lang} user={user} onOpenLevel={(id) => setView({ name: "level", params: { levelId: id } })} />}
        {view.name === "dashboard" && <Dashboard lang={lang} user={user} onOpenLevel={(id, tab) => setView({ name: "level", params: { levelId: id, tab } })} onQuickPlay={quickPlay} onGoReview={() => setView({ name: "review", params: {} })} onTechniques={() => setView({ name: "techniques", params: {} })} onConventions={() => setView({ name: "conventions", params: {} })} onGuide={() => setView({ name: "guide", params: {} })} />}
        {view.name === "levels" && <Dashboard lang={lang} user={user} onOpenLevel={(id, tab) => setView({ name: "level", params: { levelId: id, tab } })} onQuickPlay={quickPlay} onGoReview={() => setView({ name: "review", params: {} })} onTechniques={() => setView({ name: "techniques", params: {} })} onConventions={() => setView({ name: "conventions", params: {} })} onGuide={() => setView({ name: "guide", params: {} })} />}
        ...
        {view.name === "play" && view.params.deal && (
          <PlayPractice deal={view.params.deal} lang={lang} title={view.params.title} onCaptureLead={view.params.deal.d ? marks.captureLead : undefined} onCapturePlay={marks.capturePlay} onLog={marks.logEvent}
            onExit={() => setView(view.params.fromTech ? { name: "techniques", params: {} } : view.params.fromTheme ? { name: "themes", params: {} } : { name: view.params.levelId ? "level" : "dashboard", params: view.params.levelId ? { levelId: view.params.levelId } : {} })}
